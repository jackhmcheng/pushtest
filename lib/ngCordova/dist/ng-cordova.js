...
angular.module('ngCordova.plugins.push', [])
  ...
  .factory('$cordovaPush', ['$q', '$window', '$rootScope', '$timeout', '$log', function ($q, $window, $rootScope, $timeout, $log) {
    ...
    return {
      ...
      register: function (config) {
        ...
        $window.plugins.pushNotification.register(function (token) {
          $log.info('CASE: PUSH registered success' + token);
          q.resolve(token);

        }, function (error) {
          $log.info('CASE: PUSH registered FAILED' + error);
          q.reject(error);
        }, config);
